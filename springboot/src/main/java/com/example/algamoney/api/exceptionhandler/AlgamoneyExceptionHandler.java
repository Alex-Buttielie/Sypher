...
public class AlgamoneyExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers,
        ...
        List <Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemProgramador));
    ...
    public ResponseEntity <Object> handleEmptyResultDataAccessException(WebRequest request, EmptyResultDataAccessException ex){
        ...
        String mensagemProgramador = ex.toString();
    ...
    private List<Erro> criarListaDeErros(BindingResult bindingResult){
        ...
        for(FieldError fieldError : bindingResult.getFieldErrors()){
            ...
            String mensagemProgrador= fieldError.toString();

            erros.add(new Erro(mensagemUsario, mensagemProgrador));}
        return erros;
    }
}
